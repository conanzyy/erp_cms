...
<title><?php echo isset($this->site_config['web_site_name'])?$this->site_config['web_site_name']:'';?>--添加导航</title>
...
<body>
    ...
    <div class="formbody">
    <form action="<?php echo  site_url("nav/add") ; ?>?action=doadd&showpage=1" method="post">
    <div class="formtitle"><span>添加导航</span></div>
    
    <ul class="forminfo">
    <li><label>导航分类</label>
    <select name="pid">
            <option value="0" style="width:150px">一级菜单</option>
            <?php 
            	if($options){           		
    ...
    <i>请选择分类</i></li>
    <li><label>导航名称</label><input name="name" type="text" class="dfinput" /><i class="">请输入导航名称</i></li>
    <li><label>排序</label><input name="disorder" type="text" class="dfinput" value="0" /><i></i></li>
    <li><label>url地址</label><input name="url" type="text" class="dfinput" value="" /><i>温馨提示:此处的url地址格式是:控制器/方法/</i></li>
